...
cd p1 ; python ../merge_f3_result.py ; mv result.xlsx p1.xlsx  ; cd ../
cd p2 ; python ../merge_f3_result.py ; mv result.xlsx p2.xlsx  ; cd ../
cd tar; python ../merge_f3_result.py ; mv result.xlsx tar.xlsx ; cd ../
